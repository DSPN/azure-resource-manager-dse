This is a Create UI Definition file for Azure Marketplace Deployments.

It is not intended to be used alone, but rather zipped with the contents of singledc and submitted to the Azure Publish Portal.
